...
Current inventory:
\cuckoo
- cuckooautoinstall.sh - automatically install Cuckoo Sandbox, all dependencies and common processing modules.
- install_notes.sh - notes for the installation of Cuckoo Sandbox, additional processing modules and the creation of cloaked VM's.
\honeypots
- dionaea.init - init.d script for dionaea.
- dionaea.logrotate - logrotate.d script for dionaea.
- dionaea_query.py - script for performing common queries against the dionaea sqlite database.
- generate_user_db.py - script to generate a random target user database for the dionaea mysql service.
- install_notes - notes for the installation of dionaea, p0f and kippo.
